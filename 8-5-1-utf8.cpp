...
int main()
{
	...
	cout << "Length of " << high_speed_train << ": " << high_speed_train.length() << endl;
	cout << "Length of Messsage" << message << ": " << message.length() << endl;

	size_t pos = message.find(e_acute);
	if (pos != string::npos)
	{
		cout << message << " has " << e_acute << " starting at position " << pos << endl;
	}
	return 0;
}